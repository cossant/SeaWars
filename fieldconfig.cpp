...
int fconfig::count(STATUS condition)
{
	int countticker = 0;
	for (int i = 0; i < FIELDSIZE * FIELDSIZE; i++)
		if (data[i] == condition)
...
bool fconfig::PositionSafe(int index){
	/* 0__
	   ___
	   ___*/
	int posX = index % 10 - 1;
...
bool fconfig::PlacementPossible(int shipsize, int direction, int start_index)
{
...
void fconfig::PlaceShip(int shipsize, int direction, int start_index)
{
	int modX, modY;
	switch (direction)
	{
